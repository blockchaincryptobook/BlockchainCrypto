# 11. Solidity variables and functions, Part 2 (Fall 2025)
...
[**Additional types of variables 1**](11.-solidity-variables-and-functions-part-2-fall-2025.md#_4zaitm4jfpps)

[Structs 1](11.-solidity-variables-and-functions-part-2-fall-2025.md#_vkitgmkzbt4)

[Using an array with struct type variable to create a database for books 10](11.-solidity-variables-and-functions-part-2-fall-2025.md#_kg8hj7coladu)

[Using struct to create a database for store profits 14](11.-solidity-variables-and-functions-part-2-fall-2025.md#_4w3yeef70oxm)

[Searching through a struct based profits database to locate a record 19](11.-solidity-variables-and-functions-part-2-fall-2025.md#_x1oooxym7cw)

[Mapping 25](11.-solidity-variables-and-functions-part-2-fall-2025.md#_69tdi9lrwu94)

[Example use of mapping: Mapping countries to their capitals 27](11.-solidity-variables-and-functions-part-2-fall-2025.md#_tximewo0yirx)

[Using mapping and struct to create a books database 30](11.-solidity-variables-and-functions-part-2-fall-2025.md#_y2uw84rrwrx0)

[Searching through a mapping 37](11.-solidity-variables-and-functions-part-2-fall-2025.md#_hy44hjg3c978)

[**Allowing only certain addresses to search 39**](11.-solidity-variables-and-functions-part-2-fall-2025.md#_bh7liqdrngz3)

[Restricting search for the books database 40](11.-solidity-variables-and-functions-part-2-fall-2025.md#_sopt9kx2vqrg)

[Restricting more efficiently by using function modifier 42](11.-solidity-variables-and-functions-part-2-fall-2025.md#_rcy9bcns8jtn)

###

ChatGPT assistant for these class notes: [https://chatgpt.com/g/g-673f9ed9d9608191a3a2d66bccd79068-chatbot-for-solidity-variables-functions-part-2](https://chatgpt.com/g/g-673f9ed9d9608191a3a2d66bccd79068-chatbot-for-solidity-variables-functions-part-2)
...
| **Exercise 3** In this exercise, we will write the code to be able to retrieve information about the book whose record we save. We are assuming that the variable aBook is not public. Since it is not public, then only the code within the contract can view it. We will write a function that is public in accessibility that is able to retrieve the book record. We will make this function public. Type the following contract: //SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract test { struct bookRecord { string title; string author; uint bookID; } bookRecord aBook = bookRecord('Learn Java', 'TP', 1); function getBook() public view returns (bookRecord memory) { return aBook; } } - Review the function getBook(). In the () portion of returns (), we specify the type of variable that will be returned and where it will be stored. Note that even though aBook is a state variable, we are returning a copy that was generated as a result of ‘return aBook’. This copy is not a local variable in the formal sense because it was not declared inside the function. However, it is treated in the same way as a local variable because it exists only during the function call and is stored in memory, not in storage. Since the value being returned is a struct and the returned copy lives in memory, the returns() portion of the function must specify memory. |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |

| **Exercise 4**1. Modify the contract from Exercise 3 to store a new book: \[“Learning Python”,”PP”,2]. 2. Compile and deploy. 3. Use the getBook function to make sure your contract works properly. 4. What has happened to the previous book record that you had stored? Can you get to it somehow? We find that when we store information about a new book, we lose information about the book we had stored previously. What if we want to store the old book and the new book? Or even more books after that? The next section handles that. But, before that, continue with Exercise 4.\*\*Exercise 4 (continued)\*\*1. Modify your contract to store the book information within the function. That is, move the statement to store the book so that it is within the function. 2. Does your contract work? We find that our contract does not compile. See if you can get help from ChatGPT. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

**Using an array with struct type variable to create a database for books**
...
| **Exercise 5 (continued)**- Compile the contract and deploy it. - Add the following three books: 1. Learn Solidity by J. Anton, book id is 1 2. Learn Java by A. Pressley, book id is 2 3. Mastering Solidity by R. Modi, book id is 3. - Circle through the records to get a feel for how to view the entries that you have made. Note that each book is now an element of the bookRecord\[] array. To see the first book, for example, type 0 as the index value in the space to the right of the blue button for bookDatabase in the deployed contract. - See below for a shorter version of the contract. Compare it to the longer version to understand how one can make the transition from the longer version to the shorter version. // SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract Books { struct bookRecord { string title; string author; uint bookID; } bookRecord\[] public bookDatabase; function addBook(string memory inputTitle, string memory inputAuthor, uint inputBookID) public { bookDatabase.push(bookRecord(inputTitle, inputAuthor, inputBookID)); } } |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
**Using struct to create a database for store profits**
...
| **Exercise 7** Take the following contract and streamline it. Specifically, remove the isProfitable and message variables. Also, the profits variable can now be made a local variable -- we will be having a record of profits in the profitsDatabase. There is no need to refer to that variable separately. // SPDX-License-Identifier: UNLICENSED //Practicing types of variables pragma solidity >=0.8.2 <0.9.0; contract Types { //Unsigned or positive integers int public profits; //profits in wei; it is in int because it can be negative bool public isProfitable; // boolean variable that is true when profits > 0 // and false otherwise string public message; //message about performance //in the following sales and expenses are in weis function determineProfits(int\[4] memory quarterSales, int\[4] memory quarterExpenses) public { int sales; //this is the same as int sales = 0; for (uint i = 0; i < quarterSales.length; i++) { sales += quarterSales\[i]; // this is the same as sales = // sales + quarterSales\[i]; } int expenses; //this is the same as int expenses=0; for (uint i = 0; i < quarterExpenses.length; i++) { expenses += quarterExpenses\[i]; // this is the same as expenses = // expenses + quarterExpenses\[i]; } require(sales>=0 && expenses>=0); profits = sales - expenses; if (profits > 0) { isProfitable = true; message = "Well done!";} else { isProfitable = false; message = "Got to do better next time";} } } |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
**Searching through a struct based profits database to locate a record**
...
**Example use of mapping: Mapping countries to their capitals**
...
**Using mapping and struct to create a books database**
...
| **Exercise 11**1. Type the following code into Remix. // SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract BooksMapping { struct bookRecord { string title; string author; uint bookID; } mapping(string=>bookRecord) public mappedBookDatabase; function mapBook(string memory key, string memory inputTitle, string memory inputAuthor, uint inputBookID) public { mappedBookDatabase\[key] = bookRecord(inputTitle, inputAuthor, inputBookID); } } 1. Compile and deploy the contract. 2. Use the mapBook function to enter the first three key-value pairs shown below. The key for any book is a concatenation of the name of the book and the author.![](<.gitbook/assets/Unknown image (10)>) 1. Input the following in the input area for the mappedBookDatabase variable and click on mappedBookDatabase to see the result. What do you observe? Why? Learn SoliditySP Learn PythonPP Learn JavaJP 1. Now make sense of the contract. Explain in a few sentences the working of the contract. 2. Type ‘Learn RRP’ (without quotes) in the input area for the mappedBookDatabase and click on mappedBookDatabase. What do you observe? Why? 3. Let us say that the author of Learn Python comes out with a second edition of the same book and we have books and their key-value pairs as shown below. Using the contract deployed in the previous exercise, go ahead and enter the new book.![](<.gitbook/assets/Unknown image (11)>) 1. Input the following in the input area for the mappedBookDatabase variable and click on mappedBookDatabase to see the result. What do you observe? Why? Learn PythonPP |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

| **Exercise 12** We will now try to automate the key creation. 1. Type the following code into Remix. S // SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract BooksMapping { struct bookRecord { string title; string author; uint bookID; } mapping(string=>bookRecord) public mappedBookDatabase; function mapBook(string memory inputTitle, string memory inputAuthor, uint inputBookID) public { string memory concatenatedTitleAuthor = string(abi.encodePacked(inputTitle,inputAuthor)); mappedBookDatabase\[concatenatedTitleAuthor] = bookRecord(inputTitle, inputAuthor, inputBookID); } } 1. Compile and deploy the contract. 2. Use the mapBook function to enter the following information for three books: Learn Solidity by JS, book id is 1 Learn Java by JJ, book id is 2 Learn Python by JP, book id is 3 1. Input the following in the input area for the mappedBookDatabase variable and click on mappedBookDatabase to see the result. Learn SoliditySP Learn PythonPP Learn JavaJP 1. You must have noticed that this contract works just like the previous contract. However, you did not have to enter the key when entering book information. Why? To understand, look at the difference in the code between this and the previous contract. One of the new lines that you will find in the latest contract is the following: string memory concatenatedTitleAuthor = string(abi.encodePacked(inputTitle,inputAuthor)); In this new line, the part after the equal sign achieves concatenation (or joining) of two strings given by inputTitle and inputAuthor. In general, whenever you have to concatenate two strings a and b, you use the following: string(abi.encodePacked(a,b)). 1. Explain the working (i.e., the logic part within {}) of the mapBook function in a few sentences (e.g., 4-5 sentences at the most). |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| **Exercise 13**1. Type in the following contract. The contract is based on the contract in Exercise 10. Review it to answer the questions that follow. // SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract Types { mapping(string=>string) capitalOf; function enterkeyValue (string memory inputCountry, string memory inputCapital) public { capitalOf\[inputCountry] = inputCapital; } function findCapital(string memory inputCountry) public view returns (string memory) { return capitalOf\[inputCountry]; } } 1. What is the purpose of the findCapital function? In other words, what does it try to do? To answer this, remove the findCapital function and compile and deploy the contract. Can you find the capital somehow? 2. Try out the contract with a few inputs to understand it better. 3. What makes it reasonable to use ‘view’ in the findCapital function? |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

| **Exercise 14**1. Type in the following contract. The contract is the same as the contract in Exercise 12 except that the findBookInfo function is new. Also, mappedBookDatabase is no longer “public”. We, therefore have a function to retrieve information from mappedBookDatabase. A part of the function is blank. The steps that follow indicate the purpose of the function to let you fill the blank appropriately. //SPDX-License-Identifier: UNLICENSED pragma solidity ^0.8.0; contract BooksMapping { struct bookRecord { string title; string author; uint bookID; } mapping(string=>bookRecord) mappedBookDatabase; function mapBook(string memory inputTitle, string memory inputAuthor, uint inputBookID) public { string memory concatenatedTitleAuthor = string(abi.encodePacked(inputTitle,inputAuthor)); mappedBookDatabase\[concatenatedTitleAuthor] = bookRecord(inputTitle, inputAuthor, inputBookID); } function findBookInfo(string memory inputTitle, string memory inputAuthor) public view returns (bookRecord memory) { return \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_; } } 1. The blank that you see in the code needs to be filled in so that when a user calls the findBookInfo function, the user is able to see the whole book record that corresponds to the title and author provided by the user. Go ahead and fill the blank. 2. Modify the findBookInfo function so that the function returns only the ID of the book whose title and author are provided by the user. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |

### **Allowing only certain addresses to search**

#### **Restricting search for the books database**
...
| **Exercise 14**1. Type in the following contract. // SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract BooksMapping { struct bookRecord { string title; string author; uint bookID; } address public creator; constructor() { creator = msg.sender; } mapping(string=>bookRecord) public mappedBookDatabase; function mapBook(string memory inputTitle, string memory inputAuthor, uint inputBookID) public { string memory concatenatedTitleAuthor = string(abi.encodePacked(inputTitle,inputAuthor)); mappedBookDatabase\[concatenatedTitleAuthor] = bookRecord(inputTitle, inputAuthor, inputBookID); } function findBookInfo(string memory inputTitle, string memory inputAuthor) public view returns (uint) { require (msg.sender == creator, "You are not the creator of the contract."); return mappedBookDatabase\[string(abi.encodePacked(inputTitle,inputAuthor))].bookID; } } 1. Compile and deploy the contract. 2. Click on the variable ‘creator’ to find its value. Look at the address of the EOA that you used to deploy the contract (look under the label ACCOUNT). How does the value of the variable ‘creator’ compare to the address of your EOA? 3. Change your EOA to the second address in the drop down under ACCOUNT. 4. Using the mapBook function, try to enter the following as your first book: Title: Learn Java Author: JP ID: 1 1. What do you observe? Can you explain the reason behind whatever that you observe? 2. Now change your EOA back to the first one. 3. Try to enter the first book again. Are you able to? Why? 4. Using the mapBook function, enter the following as your second book: Title: Learn Solidity Author: SP ID: 2 1. Switch to the second EOA account like before. 2. Use the findBookInfo function to find the ID of the book whose title is ‘Learn Java’ and author is ‘JP’. Are you able to find the ID? Can you explain why the second EOA worked for this function? 3. Be ready to discuss your observations. |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
#### **Restricting more efficiently by using function modifier**
...
| **Exercise 15**1. Type in the following contract. // SPDX-License-Identifier: UNLICENSED pragma solidity >=0.8.2 <0.9.0; contract BooksMapping { struct bookRecord { string title; string author; uint bookID; } address public creator; constructor() { creator = msg.sender; } modifier onlyCreator { require(msg.sender==creator, 'You are not the creator.'); \_; } mapping(string=>bookRecord) public mappedBookDatabase; function mapBook(string memory inputTitle, string memory inputAuthor, uint inputBookID) onlyCreator public { string memory concatenatedTitleAuthor = string(abi.encodePacked(inputTitle,inputAuthor)); mappedBookDatabase\[concatenatedTitleAuthor] = bookRecord(inputTitle, inputAuthor, inputBookID); } function findBookInfo(string memory inputTitle, string memory inputAuthor) onlyCreator public view returns (uint) { return mappedBookDatabase\[string(abi.encodePacked(inputTitle,inputAuthor))].bookID; } } 1. Compile and deploy the contract. 2. Click on the variable ‘creator’ to find its value. Look at the address of the EOA that you used to deploy the contract (look under the label ACCOUNT). How does the value of the variable ‘creator’ compare to the address of your EOA? 3. Change your EOA to the second address in the drop down under ACCOUNT. 4. Using the mapBook function, try to enter the following as your first book: Title: Learn Java Author: JP ID: 1 1. What do you observe? Can you account for whatever that you observed? 2. Now change your EOA back to the first one. 3. Try to enter the first book again. Are you able to? 4. Using the mapBook function, enter the following as your second book: Title: Learn Solidity Author: SP ID: 2 1. Switch to the second EOA account like before. 2. Use the findBookInfo function to find the ID of the book whose title is ‘Learn Java’ and author is ‘JP’. Are you able to find the ID? Can you explain why the second EOA did not work for this function? Try your luck with the first EOA account. What do you observe? 3. Be ready to discuss your observations. |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
