...
| <p>Exercise 2</p><p>In the following contract, we write the code to view the value in a particular field -- bookID. We assume that aBook is no longer public. </p><p></p><p>Type the following contract:</p> |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| <p>Exercise 2 (continued) </p><p>In the following contract, we write the code to view the value of two fields -- bookID and title. </p><p></p><p>Type the following contract:</p> |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
